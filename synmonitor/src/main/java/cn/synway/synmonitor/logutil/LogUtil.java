package cn.synway.synmonitor.logutil;
...
public class LogUtil {
    ...
    public static void d(String tag, String msg) {
        if (getLogLevel() >= LOG_LEVEL_DEBUG && isOpen) {
            Log.d(tag, msg);
        }
    }
    ...
    public static void i(String tag, String msg) {
        if (getLogLevel() >= LOG_LEVEL_INFO && isOpen) {
            Log.i(tag, msg);
        }
    }
    ...
    public static void w(String tag, String msg) {
        if (getLogLevel() >= LOG_LEVEL_WARN && isOpen) {
            Log.w(tag, msg);
        }
    }
    ...
    public static void e(String tag, String msg) {
        if (getLogLevel() >= LOG_LEVEL_ERROR && isOpen) {
            Log.e(tag, msg);
        }
    }
    ...
    public static void v(String tag, String msg) {
        if (getLogLevel() >= LOG_LEVEL_ALL && isOpen) {
            Log.v(tag, msg);
        }
    }

    public static void setLogUtilSwitch(boolean isOpen) {
