...
//    }
    ...
    public static String getMEIDCode() {
    ...
    /**
     * 获取IMSI(双卡双待手机暂时只能获取一张卡的IMSI，)
     */
//    public static String getIMSI() {
//        TelephonyManager mTelephonyManager = (TelephonyManager) Utils.getApp().
//                getSystemService(Context.TELEPHONY_SERVICE);
//        String strIMSI;
//        strIMSI = mTelephonyManager.getSubscriberId();
//        if (strIMSI == null)
//            strIMSI = "";
//        return strIMSI;
//    }
