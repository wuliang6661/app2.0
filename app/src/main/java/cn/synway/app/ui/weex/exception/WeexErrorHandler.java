...
import cn.synway.app.ui.weex.WeexConfig;
...
public class WeexErrorHandler {
    ...
    public void writeWeexError(String errCode, String msg, String url, WxMapData wxMapData){
        ...
        //打印日志
        String logMsg = "用户名:" + UserIml.getUser().getUserID();
        logMsg += "\n";
        logMsg += "设备信息:" + deviceInfo;
        logMsg += "\n";
        logMsg += "接口文档版本:" + WeexConfig.InterfaceVersion;
        logMsg += "\n";
        logMsg += "weex的SDK版本:" + WeexConfig.WeexSdkVersion;
        logMsg += "\n";
        logMsg += "模块版本:" + WeexConfig.AppModuleVersion;
        logMsg += "\n";
        logMsg += "异常信息:\n";
