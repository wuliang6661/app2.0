 ...
 * 邮箱：rance935@163.com
 */
public class ChatSendViewHolder extends BaseViewHolder<MessageEntry> {
    ...
    private void findViewByIds(View itemView) {
        ...
        linkTitle = itemView.findViewById(R.id.tv_link_subject);
    ...
    public void setData(MessageEntry data) {
        ...
        chatItemContentText.setOnTextSpanListener((type, data1) -> onItemClickListener.onTextTypeClick(chatItemContentText, (Integer) itemView.getTag(), data1, type));
        ...
        switch (data.getFileType()) {
            ...
            case Constants.CHAT_FILE_TYPE_IMAGE:
                ...
                Glide.with(mContext).load(data.getFilepath())
                        .error(R.drawable.loding_img)
                        .placeholder(R.drawable.loding_img)
                        .centerCrop()
...
//                break;
    ...
    public void setItemClick() {
        ...
        chatItemFail.setOnClickListener(view -> onItemClickListener.onSendFiledClick(view, (Integer) itemView.getTag()));
    }
