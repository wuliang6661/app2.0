...
public class ChatContextMenu extends RelativePopupWindow {
    ...
    private MessageEntry mMessageEntry;
    private Context mContext;
    public ChatContextMenu(Context context, MessageEntry messageEntry) {
    ...
    private void copyToClipboard() {
        ...
        ClipData data = ClipData.newPlainText("Moa", mMessageEntry.getContent());
