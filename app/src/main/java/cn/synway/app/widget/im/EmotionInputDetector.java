...
import cn.synway.app.widget.imutil.AudioRecorderUtils;
import cn.synway.app.widget.imutil.Constants;
import cn.synway.app.widget.imutil.PopupWindowFactory;
...
public class EmotionInputDetector {
    ...
    public EmotionInputDetector bindToSendButton(View sendButton) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                messageEntry.setContent(mEditText.getText().toString());
    ...
    public EmotionInputDetector bindToVoiceButton(final ImageView voiceButton) {
        voiceButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isShowVoice) {
                    voiceButton.setImageResource(R.drawable.icon_voice);
                } else {
                    voiceButton.setImageResource(R.drawable.icon_keyboard);
                }
    ...
    public EmotionInputDetector build() {
        ...
        mAudioRecorderUtils.setOnAudioStatusUpdateListener(new AudioRecorderUtils.OnAudioStatusUpdateListener() {
            ...
            public void onStop(long time, String filePath) {
                ...
                MessageEntry messageEntry = new MessageEntry();
                messageEntry.setFileType(Constants.CHAT_FILE_TYPE_VOICE);
                messageEntry.setFilepath(filePath);
                messageEntry.setVoiceTime(time);
                EventBus.getDefault().post(messageEntry);
            }
    ...
    onLayoutVisableListener listener;

    public void setOnLayoutVisableListener(onLayoutVisableListener listener) {
     ...
     * 底部布局展示的监听
     */
    public interface onLayoutVisableListener {
