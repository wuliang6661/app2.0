...
public class MessageHandlerFactory {
    ...
    static {
        ...
        /** 单聊消息处理handler*/
        HANDLERS.put(MessageType.MESSAGE_CHAT.getMsgType(), new MessageChatHandler());
        /** 服务端返回的消息发送状态报告处理handler */
        HANDLERS.put(MessageType.SERVER_MSG_SENT_STATUS_REPORT.getMsgType(), new ServerReportMessageHandler());
        /** 服务端返回的禁用设备、刷新应用列表的通知*/
        HANDLERS.put(MessageType.SERVER_NOTIFICATION.getMsgType(), new ServerNotificationHandler());
    }
