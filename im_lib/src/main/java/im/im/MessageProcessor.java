...
import im.bean.BaseMessage;
import im.bean.ContentMessage;
import im.im.handler.IMessageHandler;
import im.im.handler.MessageHandlerFactory;
import im.utils.CThreadPoolExecutor;
