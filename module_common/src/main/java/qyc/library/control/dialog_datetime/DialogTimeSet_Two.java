...
public class DialogTimeSet_Two extends Dialog {
	...
	public DialogTimeSet_Two(Context context) {
		super(context);
	}

	public DialogTimeSet_Two(Context context, String title) {
		super(context);
		this.title = title;
	}

	public DialogTimeSet_Two(Context context, String title, Calendar calStart,
			Calendar calStop) {
		super(context);
		this.title = title;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lib_dialogtimesettwo_cv);
		if (title != null) {
			setTitle(title);
		}
		...
		public void onClick(View arg0) {
			if (arg0 == btn_cancel) {
				if (onClickListener != null) {
					onClickListener.onClick(DialogTimeSet_Two.this,
							BUTTON_NEGATIVE);
				}
				dismiss();
