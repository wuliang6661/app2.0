package qyc.library.control.progress_wheel;
...
public class ProgressWheel extends View {
	...
	private void parseAttributes(TypedArray a) {
		...
		spinSpeed = (int) a.getDimension(R.styleable.ProgressWheel_progressWheelSpinSpeed, spinSpeed);

		delayMillis = a.getInteger(R.styleable.ProgressWheel_progressWheelDelayMillis, delayMillis);
		if (delayMillis < 0) {
			delayMillis = 0;
		}
		...
		barLength = (int) a.getDimension(R.styleable.ProgressWheel_progressWheelBarLength, barLength);

		textSize = (int) a.getDimension(R.styleable.ProgressWheel_progressWheelTextSize, textSize);

		textColor = a.getColor(R.styleable.ProgressWheel_progressWheelTextColor, textColor);

		// if the text is empty , so ignore it
		if (a.hasValue(R.styleable.ProgressWheel_progressWheelText)) {
			setText(a.getString(R.styleable.ProgressWheel_progressWheelText));
		}

		rimColor = a.getColor(R.styleable.ProgressWheel_progressWheelRimColor, rimColor);

		circleColor = a.getColor(R.styleable.ProgressWheel_progressWheelCircleColor, circleColor);

		contourColor = a.getColor(R.styleable.ProgressWheel_progressWheelContourColor, contourColor);
		contourSize = a.getDimension(R.styleable.ProgressWheel_progressWheelContourSize, contourSize);
