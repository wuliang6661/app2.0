...
//        mAudioManager.setMode(AudioManager.MODE_NORMAL);
    ...
    public void start() {
        ...
        path = VOICE_FOLDER_PATH + "/" + startRecordTime + fileSuffix;
        fileName = startRecordTime + fileSuffix;
...
//        }
    ...
    private void openBlueToothMic2() {
    ...
    private void initBlueToothHeadset() {
        ...
        blueToothAdapter.getProfileProxy(context, new ServiceListener() {
            @Override
