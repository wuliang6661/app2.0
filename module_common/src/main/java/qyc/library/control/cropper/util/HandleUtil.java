...
package qyc.library.control.cropper.util;

import android.content.Context;
import android.util.Pair;
import android.util.TypedValue;

import qyc.library.control.cropper.cropwindow.CropOverlayView;
import qyc.library.control.cropper.cropwindow.handle.MHandler;
...
public class HandleUtil {
     ...
     * @return the MHandler that was pressed; null if no MHandler was pressed
     */
    public static MHandler getPressedHandle(float x,
                                            float y,
                                            float left,
                                            float top,
                                            float right,
     ...
     */
    public static Pair<Float, Float> getOffset(MHandler handle,
                                               float x,
                                               float y,
                                               float left,
                                               float top,
