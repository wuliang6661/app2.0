...
package qyc.library.control.cropper.cropwindow.handle;

import android.graphics.Rect;

import qyc.library.control.cropper.cropwindow.edge.Edge;
import qyc.library.control.cropper.cropwindow.edge.EdgePair;
import qyc.library.control.cropper.util.AspectRatioUtil;

/**
 * Abstract helper class to handle operations on a crop window MHandler.
 */
