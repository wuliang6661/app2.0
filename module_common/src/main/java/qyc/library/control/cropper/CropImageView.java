...
package qyc.library.control.cropper;
...
import qyc.library.control.cropper.util.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
	...
	private void init(Context context) {
		...
		final View v = inflater.inflate(R.layout.lib_crop_image_view, this, true);
