...
package qyc.library.control.cropper.cropwindow;
...
import qyc.library.control.cropper.CropImageView;
import qyc.library.control.cropper.cropwindow.edge.Edge;
import qyc.library.control.cropper.cropwindow.handle.MHandler;
import qyc.library.control.cropper.util.AspectRatioUtil;
import qyc.library.control.cropper.util.HandleUtil;
import qyc.library.control.cropper.util.PaintUtil;
...
public class CropOverlayView extends View {
    ...
    // The radius of the touch zone (in pixels) around a given MHandler.
    ...
    // The MHandler that is currently pressed; null if no MHandler is pressed.
    private MHandler mPressedHandle;
