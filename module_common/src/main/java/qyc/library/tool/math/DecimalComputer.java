...
public class DecimalComputer {
	 ...
	 * @throws NO
	 */
	public static final byte[] bytesCopy(byte[] byte1, int byte1Length, byte[] byte2, int byte2Length) {
	...
	public static final byte[] bytesCopy(byte[] byte1, int byte1position, int byte1Length, byte[] byte2,
			int byte2position, int byte2Length) {
		byte[] byteTemp_receiveByte = new byte[byte1Length + byte2Length];
		System.arraycopy(byte1, byte1position, byteTemp_receiveByte, 0, byte1Length);
		System.arraycopy(byte2, byte2position, byteTemp_receiveByte, byte1Length, byte2Length);
		return byteTemp_receiveByte;
	}
