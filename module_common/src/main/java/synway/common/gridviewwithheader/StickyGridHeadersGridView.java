...
package synway.common.gridviewwithheader;
...
public class StickyGridHeadersGridView extends GridView implements OnScrollListener,
    ...
    private void measureHeader() {
        ...
        mStickiedHeader.measure(MeasureSpec.makeMeasureSpec(0,MeasureSpec.UNSPECIFIED), MeasureSpec.makeMeasureSpec(0,0));
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        for (int i = 0; i < headerPositions.size(); i++) {
            ...
            header.measure(MeasureSpec.makeMeasureSpec(0,MeasureSpec.UNSPECIFIED),MeasureSpec.makeMeasureSpec(0,0));
