...
class SyncGetPublicByDB2 {

    private Handler handler = null;

    public SyncGetPublicByDB2() {
        handler = new Handler();
    }
...
//			}
            handler.post(new Runnable() {
                ...
                public void run() {
                    if (null != lsn) {
                        ...
                        lsn.onResult(resultList, selePos);
                    }
                }
            });
    ...
    interface IOnGetAccountByDB {
        void onResult(ArrayList<Obj_PublicAccount> arrayList, HashMap<String, Integer> selePos);
