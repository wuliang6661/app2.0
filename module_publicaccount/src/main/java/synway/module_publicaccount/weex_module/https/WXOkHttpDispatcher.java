 ...
 * under the License.
 */
package synway.module_publicaccount.weex_module.https;
...
//            .connectTimeout(DEFAULT_CONNECT_TIMEOUT_MILLIS, TimeUnit.MILLISECONDS)//设置连接超时时间
//            .readTimeout(DEFAULT_READ_TIMEOUT_MILLIS, TimeUnit.MILLISECONDS)//设置读取超时时间
