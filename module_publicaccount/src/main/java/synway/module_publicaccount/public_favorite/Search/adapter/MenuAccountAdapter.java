...
public class MenuAccountAdapter extends BaseAdapter {

	private ArrayList<Obj_Menu> objList = null;
	private HashMap<String, Obj_Menu> hashMap = null;
	private LayoutInflater inflater = null;
	private String keyWord;

	public MenuAccountAdapter(Context context) {
		objList = new ArrayList<Obj_Menu>();
		hashMap = new HashMap<String, Obj_Menu>();
		inflater = LayoutInflater.from(context);
	}
	public void setKeyWord(String keyWord){
		this.keyWord = keyWord;
	}
	public void reset(ArrayList<Obj_Menu> list) {
		this.objList.clear();
		this.objList = list;

		this.hashMap.clear();
		for (Obj_Menu objP : list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		Obj_Menu obj = objList.get(position);
	...
	private void initHolder(ViewHolder holder, Obj_Menu obj) {
		if(obj.isItem) {
			...
			holder.tvText.setText(obj.menuFather);
		}
