package synway.module_publicaccount.public_chat.horizontal_listview;
...
/**
 * 备注：抽取这一view的目的是根据业务需求，改造这一view，增加了item的长按事件
 */
...
public class LinearListView extends IcsLinearLayout {
    ...
    private class InternalOnLongClickListener implements OnLongClickListener{
        ...
        @Override public boolean onLongClick(View v) {
            if((onItemLongClickListener!=null) && (mAdapter !=  null)){
                onItemLongClickListener.onItemLongClick(LinearListView.this, v,
                    mPosition, mAdapter.getItemId(mPosition));
            }
